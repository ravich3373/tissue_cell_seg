...
class TissueNetNucleus(Dataset):
    ...
    def __getitem__(self, idx):
        dapi_stain_img =  data_dicts[self.split]["X"][idx][:,:,0]  #self.imgs[idx][:,:,0]
        instance_mask = data_dicts[self.split]["y"][idx][:,:,0]  #self.segs[idx][:,:,0]
    ...
    def __len__(self):
        return len(data_dicts[self.split]["X"])

import pdb; pdb.set_trace()
train_dataset = TissueNetNucleus(data_root, "train", transform=transform_train)
valid_dataset = TissueNetNucleus(data_root, "val", transform=transform_train)
test_dataset = TissueNetNucleus(data_root, "test", transform=transform_train)
